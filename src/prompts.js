...
const briefOverviews = {
    templateInfo: `\nOverview of the Asset Browse extension template for the AEM Assets View:\n
  * You have the option to generate boilerplate code for your custom ActionBar action.
...
const promptMainMenu = (manifest) => {
    ...
    choices.push(
        ...
        {
            name: 'Add an action to the ActionBar',
